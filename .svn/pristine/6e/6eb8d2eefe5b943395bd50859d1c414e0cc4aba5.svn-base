...
public class CustomerBrowseAct extends FragActBase implements SearchView.OnQueryTextListener
,IBaseScanFragment{
    ...
    @ViewById
    SearchView customer_search_view;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SjcjLLSuccess:
                    ...
                    customercollectbrowseCollectlistviewLv.setAdapter(commonAdapter);
                    customer_search_view.setOnQueryTextListener(CustomerBrowseAct.this);
                    customer_search_view.setSubmitButtonEnabled(false);
                    customercollectbrowseZPZTv.setText(sjcj_ll.get(0).getZPZ());
                    customercollectbrowseZMYTv.setText(sjcj_ll.get(0).getZMY());
                    customercollectbrowseZSLTv.setText(sjcj_ll.get(0).getZSL());
                    break;
    ...
    @AfterViews
    protected void main() {
        App.getInstance().addActivity(CustomerBrowseAct.this);
        customercollectbrowseCustomerTv.setText(getXml("CUS_KHMC", "1"));
        foodView = LayoutInflater.from(CustomerBrowseAct.this).inflate(R.layout.lv_loadmore, null);
        loadmoreTV = (TextView) foodView.findViewById(R.id.loadMoreTV);
        loadmorePB = (ProgressBar) foodView.findViewById(R.id.bar);
        customercollectbrowseCollectlistviewLv.addFooterView(foodView);
        customercollectbrowseCollectlistviewLv.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    private void selectAll() {
        ...
        params.put("KHID", getXml("CUS_KHBMID", ""));
    ...
    private void updateLayout(final List<SjcjLLBeanClass.SjcjLLBean> searchList) {
        ...
        customercollectbrowseCollectlistviewLv.setAdapter(searchAdapter);
    }
    ...
    public void onGetBarcode(String barcode) {
        ...
        customer_search_view.setQuery(barcode,false);
        hideInputMethod();
    }
